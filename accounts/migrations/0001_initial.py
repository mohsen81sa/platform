    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('used_at', models.DateTimeField(blank=True, help_text='When this asset was last used by AI', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('pending', 'Pending'), ('active', 'Active'), ('completed', 'Completed'), ('paused', 'Paused')], default='pending', max_length=50)),
                ('session_type', models.CharField(choices=[('single', 'Single Session'), ('multiple', 'Multiple Sessions')], default='single', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('PENDING', 'Pending'), ('APPROVED', 'Approved'), ('REJECTED', 'Rejected'), ('PUBLISHED', 'Published'), ('DRAFT', 'Draft')], default='PENDING', help_text='Status of the post', max_length=20)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('crontab_schedule', models.CharField(help_text="Format: 'minute hour day_of_week month day_of_month' (e.g., '*/15 * * * *')", max_length=100, verbose_name='Crontab Schedule')),
                ...
                ('campaign', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='schedules', to='accounts.campaign', verbose_name='Campaign')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('notification_url', models.URLField(help_text='URL sent to user for posting', max_length=500)),
                ...
                ('campaign', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='notifications', to='accounts.campaign')),
